    ...
    return (
      <div style={{ ...bg, minHeight: "100vh", fontFamily: "'Georgia', serif" }}>
        ...
        <div style={{ margin: "0 24px", background: "linear-gradient(135deg, rgba(212,168,83,0.1), rgba(138,105,58,0.1))", border: `1px solid ${borderCol}`, borderRadius: "24px", overflow: "hidden", padding: "40px", textAlign: "center" }}>
          ...
          <p style={{ color: subtleText, fontSize: "14px", marginBottom: "20px" }}>Klikni na lokal ispod da vidiš detalje.</p>
          <div style={{ display: "grid", gap: "12px" }}>
            {cafes.map(c => (
              <button key={c.id} onClick={() => { setSelectedCafe(c); setShowMap(false); setPage("detail"); }} style={{ display: "flex", alignItems: "center", gap: "14px", padding: "14px 16px", background: cardBg, border: `1px solid ${borderCol}`, borderRadius: "14px", cursor: "pointer", textAlign: "left", color: "inherit" }}>
    ...
    <div style={{ ...bg, minHeight: "100vh", fontFamily: "'Georgia', serif", overflowX: "hidden" }}>
      ...
      <div style={{ position: "relative", minHeight: "100svh", display: "flex", flexDirection: "column", justifyContent: "flex-end", paddingBottom: "60px", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", padding: "0 24px", paddingTop: "100px" }}>
          ...
          <p style={{ color: subtleText, fontSize: "16px", lineHeight: 1.6, margin: "0 0 32px", maxWidth: "340px" }}>Autentične recenzije kafića, brunch mesta i lokacija koje vredi posetiti u Čačku.</p>
          <div style={{ position: "relative", marginBottom: "20px", maxWidth: "480px" }}>
            ...
            <input value={searchQuery} onChange={e => setSearchQuery(e.target.value)} placeholder='Traži "cozy kafić" ili "brunch"…' style={{ width: "100%", padding: "16px 16px 16px 46px", background: darkMode ? "rgba(255,255,255,0.06)" : "rgba(0,0,0,0.05)", border: `1px solid ${borderCol}`, borderRadius: "16px", color: "inherit", fontSize: "15px", outline: "none", backdropFilter: "blur(10px)", boxSizing: "border-box", fontFamily: "inherit" }}/>
          </div>
          <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
            ...
            <button onClick={() => setShowMap(true)} style={{ background: darkMode ? "rgba(255,255,255,0.06)" : "rgba(0,0,0,0.05)", border: `1px solid ${borderCol}`, color: "inherit", borderRadius: "14px", padding: "14px 28px", fontSize: "15px", cursor: "pointer", fontFamily: "inherit" }}>🗺️ Mapa</button>
          </div>
